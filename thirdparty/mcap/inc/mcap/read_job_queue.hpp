 ...
 */
   ...
   */
            ...
            static bool CompareForward(const ReadJob& a, const ReadJob& b) {
                ...
                if (aTimestamp == bTimestamp) { return PositionComparisonKey(a, false) > PositionComparisonKey(b, false); }
            ...
            static bool CompareReverse(const ReadJob& a, const ReadJob& b) {
                ...
                if (aTimestamp == bTimestamp) { return PositionComparisonKey(a, true) < PositionComparisonKey(b, true); }
                return aTimestamp < bTimestamp;
            }
