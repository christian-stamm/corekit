    ...
    namespace {
        ...
        class SuccessfulTask final : public Task {
            ...
            protected:
                ...
                bool on_enter(StopToken) override {
                    m_callbacks.push_back(Callback::ENTER);
                    return {};
                }

                bool on_run(StopToken) override {
                    m_callbacks.push_back(Callback::RUN);
                    return {};
                }

                bool on_leave(StopToken) override {
        ...
        class StopTokenTask final : public Task {
            ...
            protected:
                ...
                bool on_enter(StopToken token) override {
                    enter_stop_requested = token.stop_requested();
                    return {};
                }

                bool on_run(StopToken token) override {
                    run_stop_requested = token.stop_requested();
                    return {};
                }

                bool on_leave(StopToken token) override {
        ...
        class EnterFailingTask final : public Task {
            ...
            protected:
                ...
                bool on_enter(StopToken) override { return RuntimeError("on_enter failed"); }
        ...
        class EnterThrowingTask final : public Task {
            ...
            protected:
                ...
                bool on_enter(StopToken) override { throw std::runtime_error("on_enter threw"); }
        ...
        class RunThrowingTask final : public Task {
            ...
            protected:
                ...
                bool on_run(StopToken) override { throw std::runtime_error("on_run threw"); }
