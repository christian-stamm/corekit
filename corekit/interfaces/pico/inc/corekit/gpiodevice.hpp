...
namespace corekit::Gpio {
    ...
    extern bool
    setChannelIRQ(uint pin, uint32_t events = GPIO_IRQ_EDGE_RISE | GPIO_IRQ_EDGE_FALL, Handle callback = nullptr);
    ...
    class IsrDaemon : public Task {
        ...
        protected:
            ...
            virtual bool on_init(StopToken token) override;
            virtual bool on_exec(StopToken token) override;
            virtual bool on_exit(StopToken token) override;
