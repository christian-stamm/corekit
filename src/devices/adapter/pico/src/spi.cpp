...
namespace corekit {
    ...
    SPI::SPI(spi_inst_t*        instance,    //
        ...
        : AsyncDevice(
              "SPI" + std::to_string(spi_get_index(instance)),            //
    ...
    void SPI::loopback(bool enabled) {
